...
<s:form>
	...
	<div class="textBox">
		...
		<p>
			<s:text name="txtMdlProtocollErfassungsdatum"></s:text>: <s:property value="%{newPruefungsleistungenList.get(newPruefungsleistungenList.size() - 1).getErfassungsdatum()}" />
		</p>
		<p>
