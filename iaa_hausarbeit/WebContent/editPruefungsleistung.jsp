...
<s:form>
	...
	<div class="form">
		...
		<s:if test="pruefungsleistung.ergaenzungspruefung != null">
			<div class="field">
				<span class="label"><s:text name="txtLabelNoteErgaenzungspruefung" /></span>
		...
		<div class="field">
			<span class="label"><s:text name="txtLabelAktuelleNote" /></span>
			<span><s:property value="%{pruefungsleistung.getEndNote()}" /></span>
			<div class="clear"></div>
		</div>
		
		<div class="field">
			<span class="label"><s:text name="txtLabelNeueNote" /></span>
			<span>
